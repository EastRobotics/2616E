...
#pragma config(Motor,  port2,           driveFL,       tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_1)
#pragma config(Motor,  port3,           driveBL,       tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_2)
	...
	*/
	...
	while (true)
	{
		...
		if(!vexRT[Btn6D]) { // Normal drive... Bottom left bumper
			...
			//TODO Fix Input
			driveWithLogic(lastForwardSpeed, lastTurnSpeed, lastStrafeSpeed, 0.0, 0.0, 0.0);
