...
#pragma config(Motor,  port1,           chooR1,        tmotorVex393_HBridge, openLoop)
...
#pragma config(Motor,  port4,           chooR2,        tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           chooR3,        tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           chooL1,        tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port7,           chooL2,        tmotorVex393_MC29, openLoop, reversed)
...
#pragma config(Motor,  port10,          chooL3,        tmotorVex393_HBridge, openLoop, reversed)
...
task taskLauncherReset() {
	...
	int lastValue = SensorValue[potLauncher];
	int stoppedCount = 0;
	while(true) {
...
task taskLaunch() {
	...
	while(true) {
		int currentAngle = SensorValue[potLauncher];
		sprintf(debug,"%i < %i?",SensorValue[potLauncher],launchPoint);
	...
	while(true) {
		int currentAngle = SensorValue[potLauncher];
		if ((SensorValue[potLauncher])<launchPoint)
