...
#pragma config(Motor,  port8,           driveFR,       tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_3)
#pragma config(Motor,  port9,           driveBR,       tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_4)
