...
#pragma config(Motor,  port1,           clawR,         tmotorVex393_HBridge, openLoop, reversed, encoderPort, I2C_4)
#pragma config(Motor,  port2,           driveFR,       tmotorVex393_MC29, openLoop, reversed, driveLeft)
#pragma config(Motor,  port3,           driveBR,       tmotorVex393_MC29, openLoop, reversed, driveLeft, encoderPort, I2C_1)
...
#pragma config(Motor,  port10,          clawL,         tmotorVex393_HBridge, openLoop, reversed, encoderPort, I2C_3)
