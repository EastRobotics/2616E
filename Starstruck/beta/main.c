...
#pragma config(Motor,  port2,           driveFR,       tmotorVex393_MC29, openLoop, reversed, driveLeft, encoderPort, I2C_3)
...
#pragma config(Motor,  port9,           driveBL,       tmotorVex393_MC29, openLoop, driveRight, encoderPort, I2C_2)
